$(function() {
	...
	metro.pullrefresh(function() {
		...
		var htmlbook = '<div class="course-div"><div class="course-head"><img src="img/qa-arrows.png" class="arrow" style="display: inline;" /><span class="course-head-title">你可能需要的图书</span><a href="#"><span class="course-more">更多</span><img src="img/qa-more.png" class="course-img-more" style="display: inline;" /></a></div><div class="course-wrap mui-scroll-wrapper mui-slider-indicatorcode mui-segmented-control mui-segmented-control-inverted"><div style="width: 90.6rem;height: 18.8rem;" class="mui-scroll">' + bookeach + bookeach + bookeach + '</div></div></div>';
